...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__group__ = __webpack_require__(2);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    }, Object(__WEBPACK_IMPORTED_MODULE_0_laravel_nova__["mapProps"])(['showHelpText'])),
            ...
            ? _c(
                ...
                _vm._l(_vm.orderedGroups, function(group, index) {
                  return _c("form-nova-flexible-content-group", {
                    key: group.key,
                    attrs: {
                      dusk: _vm.field.attribute + "-" + index,
                      field: _vm.field,
                      group: group,
                      index: index,
                      "resource-name": _vm.resourceName,
    ...
    mounted: function mounted() {
        ...
        if (this.field.defaultLayout && this.layouts.length === 1) {
            this.$nextTick(function () {
                return _this.addGroup(_this.layouts[0]);
            });
        }
    }
});
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        [_vm._v(_vm._s(_vm.__("Delete Group")))]
                      ),
                      _vm._v(" "),
                      _vm.message
